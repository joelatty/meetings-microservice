...
public class WebsocketRouteTest extends WebsocketCamelRouterTestSupport {
    ...
    public void testWebsocketSingleClient() throws Exception {
        TestAtmosphereClient wsclient = new TestAtmosphereClient("ws://localhost:" + PORT + "/hola");
        wsclient.connect();
    ...
    public void testWebsocketSingleClientForReader() throws Exception {
        TestAtmosphereClient wsclient = new TestAtmosphereClient("ws://localhost:" + PORT + "/hola3");
        wsclient.connect();
    ...
    public void testWebsocketBroadcastClient() throws Exception {
        TestAtmosphereClient wsclient1 = new TestAtmosphereClient("ws://localhost:" + PORT + "/hola2", 2);
        TestAtmosphereClient wsclient2 = new TestAtmosphereClient("ws://localhost:" + PORT + "/hola2", 2);
        wsclient1.connect();
        wsclient2.connect();
